...
function nextBilder(){
	...
	if((Kategorien[kat].fortschritt+2) == katBegriffe.length){
	wort1 = katBegriffe[Kategorien[kat].fortschritt];
	wort2 = katBegriffe[(Kategorien[kat].fortschritt)+1];
	wort3 = katBegriffe[0];
	}
	else if((Kategorien[kat].fortschritt+2) == katBegriffe.length+1){
	wort1 = katBegriffe[Kategorien[kat].fortschritt];
	wort2 = katBegriffe[0];
	wort3 = katBegriffe[1];
	}
	...
	wort1 = katBegriffe[Kategorien[kat].fortschritt];
	wort2 = katBegriffe[(Kategorien[kat].fortschritt)+1];
	wort3 = katBegriffe[(Kategorien[kat].fortschritt)+2];
	}
